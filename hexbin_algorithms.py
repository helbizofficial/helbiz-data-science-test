...
def gen_bins_with_bin_width(data: list, bin_width: float):
    """
    ...
    hexagon_centers = list()
    vehicle_counts = list()
    for k, v in bins.items():
        hexagon_centers.append(eval(k))
        vehicle_counts.append(v)
    return hexagon_centers, vehicle_counts
